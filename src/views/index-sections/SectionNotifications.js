          ...
          <Container>
            <div className='alert-wrapper'>
              ...
              <div className='message'>
                <i className='nc-icon nc-bell-55' /> This is a notification with close button and
                icon.
              </div>
            </div>
          </Container>
        ...
        <Alert className='alert-with-icon' color='danger' isOpen={alertDanger}>
          <Container>
            <div className='alert-wrapper'>
              ...
              <div className='message'>
                <i className='nc-icon nc-bell-55' /> This is a notification with close button and
                icon and have many lines. You can see that the icon and the close button are always
