        ...
        <Container>
          ...
          <Row id='modals'>
            ...
            <Col md='6'>
              ...
              <UncontrolledPopover placement='top' target='tooltip344834141' trigger='focus'>
              ...
              <UncontrolledPopover placement='bottom' target='tooltip493417725' trigger='focus'>
            ...
            <Col md='6'>
              ...
              <Button className='btn-round mr-1' color='danger' id='tooltip392938669' outline>
                On left
              </Button>
              <UncontrolledTooltip delay={0} placement='left' target='tooltip392938669'>
                On left
              </UncontrolledTooltip>
              <Button className='btn-round mr-1' color='danger' id='tooltip354225297' outline>
                On right
              </Button>
              <UncontrolledTooltip delay={0} placement='right' target='tooltip354225297'>
                On right
              </UncontrolledTooltip>
              <Button className='btn-round mr-1' color='danger' id='tooltip739061283' outline>
                On top
              </Button>
              <UncontrolledTooltip delay={0} placement='top' target='tooltip739061283'>
                On top
              </UncontrolledTooltip>
              <Button className='btn-round' color='danger' id='tooltip984013562' outline>
                On bottom
              </Button>
              <UncontrolledTooltip delay={0} placement='bottom' target='tooltip984013562'>
                On bottom
              </UncontrolledTooltip>
            </Col>
          </Row>
