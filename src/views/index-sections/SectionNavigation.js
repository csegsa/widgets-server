      ...
      <div className='section section-navigation'>
        ...
        <div id='navbar'>
          <div
            ...
            style={{
              backgroundImage: "url(" + require("assets/img/ilya-yakover.jpg").default + ")"
            }}
          >
            ...
            <Navbar className='bg-success' expand='lg'>
              <Container>
                ...
                <UncontrolledCollapse navbar style={{}} toggler='#navbar-success'>
                  <Nav className='ml-auto' navbar>
                    <NavItem>
                      <NavLink href='#pablo' onClick={e => e.preventDefault()}>
                        <i aria-hidden={true} className='nc-icon nc-compass-05' />
            ...
            <Navbar className='bg-danger' expand='lg'>
              <Container>
                ...
                <UncontrolledCollapse navbar style={{}} toggler='#navbar-danger'>
                  <Nav className='ml-auto' navbar>
                    <NavItem>
                      <NavLink href='#pablo' onClick={e => e.preventDefault()}>
                        <i aria-hidden={true} className='fa fa-facebook-official' />
